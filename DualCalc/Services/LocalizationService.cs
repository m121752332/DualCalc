...
namespace DualCalc.Services
{
    ...
    public class LocalizationService : INotifyPropertyChanged
    {
        ...
        // ── Resource lookup ───────────────────────────────────
        private static void ApplyLanguageOverride(AppLanguage language)
        {
            string languageTag = language == AppLanguage.ZhHant ? "zh-Hant" : "zh-Hans";
            ApplicationLanguages.PrimaryLanguageOverride = languageTag;
            ResourceContext.SetGlobalQualifierValue("Language", languageTag);
        }

        private void ApplyLanguageOverride() => ApplyLanguageOverride(_language);
        ...
        public string Get(string key)
        {
            ...
            catch { return key; } // fallback: return key itself
        }
